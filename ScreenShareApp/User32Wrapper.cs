...
namespace WinAPI
{
    ...
    public class User32Wrapper
    {
        ...
        internal static extern int SetWindowLong(IntPtr hWnd, int getWindowLongEnum, int windowsExtendedStyle);

        [DllImport("user32.dll", EntryPoint = "SetLayeredWindowAttributes")]
        internal static extern Boolean SetLayeredWindowAttributes(IntPtr hWnd, int key, Byte alpha, int layeredWindowAttribute);
